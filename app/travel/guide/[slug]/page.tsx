...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{
  ...
  return {title:`${p.title} | Custom Trip Planner`,description:p.description,alternates:{canonical:`/travel/guide/${p.slug}`},
    openGraph:{title:`${p.title} | InfiO2 Travel`,description:p.description,type:"website"}};
}
