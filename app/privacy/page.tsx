...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for the InfiO2 Travel website and travel inquiry services.",
...
export default function PrivacyPage() {
  return (
    <main className="legal-page"><article className="legal">
      ...
      <p>This starter privacy policy describes how information submitted through the InfiO2 Travel website may be handled. Before launch, replace placeholders with your actual business information and have the policy reviewed for the jurisdictions where you operate.</p>
      ...
      <h2>Data security</h2><p>Reasonable administrative and technical measures should be used to safeguard personal information. No internet transmission or electronic storage system can be guaranteed to be completely secure.</p>
